 ...
 * @author Eltaher
 */
public class CustomPresidentLinkedListExample {
        ...
        try {
            ...
            do {
                ...
                if (name.compareToIgnoreCase("x") != 0)
                {
                    ...
                    CustomLinkedList_Management.addPresident(new CustomPresident(name, startYear, endYear));
                    counter++;
                }
                else if (counter < 3)
                {
            ...
            System.out.println();       
            System.out.println(CustomLinkedList_Management.getFirstPresident().toString());
            
            System.out.println();
            System.out.println("Here is the LAST President in the List...");
            System.out.println();       
            System.out.println(CustomLinkedList_Management.getLastPresident().toString());            
            ...
            CustomLinkedList_Management.insertPresident(new CustomPresident(name, startYear, endYear), 1);
            ...
            System.out.println();
            CustomLinkedList_Management.removePresident(2);
            ...
            name = scan.nextLine(); 
            CustomPresident p = CustomLinkedList_Management.getByPresidentName(name);
            
            System.out.println();
            if (p != null)
            {
                CustomLinkedList_Management.removePresident(p);
                List_All_Presidents();                        
            }
            else
    ...
    public static void List_All_Presidents()
    {
        ...
        System.out.println();
        CustomLinkedList_Management.listAllPresidents();            
    }
